"""HTML helper functions for MagnitSearch.

Provides formatting and utility functions for HTML generation including
price/weight formatting, discount calculations, and content filtering.
"""
